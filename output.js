let fakeInput = {
  "stateGroups": [
    ...
    {"stateCode": "CA", "investorNumber": 20, "totalInvested": 200000, "regD": "b"},
    {"stateCode": "CA", "investorNumber": 3, "totalInvested": 60000, "regD": "c"},
    {"stateCode": "ME", "investorNumber": 11, "totalInvested": 300000, "regD": "b"}
  ]
};
...
function calculate(input, checkAgainst) {
  ...
  function calculateReturnFiling(state) {
    ...
    if (state.investorNumber < state.threshhold) {
      returnFilingMessage = "not required because the investor threshold has not been met"
    } else if (state.filingType === "none") {
      returnFilingMessage = "not required"
